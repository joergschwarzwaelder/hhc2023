...
```
It uses the database user "targeter_admin" to interact with the database. This user has "update" permissions on the tables "pointing_mode" and "satellite_query". With this password hash and a modified MySQL client it
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwOTM3NjQxMjQsLTQzNDQ1NjU1MywxMz
